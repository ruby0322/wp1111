...
https://wp-final-project-af0a8.web.app

## Github link

https://github.com/ruby0322/wp1111/tree/main/final

## FB 社團貼文網址

https://www.facebook.com/groups/NTURicWebProg/permalink/1828707517477160/

## 使用/操作方式
Plink有五個主要頁面：
1. 首頁：瀏覽推薦的活動，與你已追蹤的活動，點擊活動時可以看到活動詳細資訊，在活動介面中點擊發起人可以看到更詳細的主揪個人資訊。
    在活動介面可以報名、追蹤或分享活動，也可以取消追蹤，主揪可以選擇終止活動或成團，終止或成團後其他使用者將無法再報名活動。原本的設計是希望可以在成團後幫所有報名的使用者與主揪建立一個群組聊天室，方便討論更多活動內容，但因為聊天室尚未實作完故沒有此功能。
    在主揪個人資訊介面可以追蹤主揪，主揪會顯示在個人頁面的追蹤名單中。
2. 搜尋：使用兩種搜尋方式：文字搜尋與標籤搜尋，過濾出符合條件的揪卡
3. 發起：填寫活動標題、內容、類別、人數、日期、時間、地點、費用等資訊，發出「揪卡」邀請其他使用者參加
4. 訊息：選擇使用者或是揪團的聊天室聊天（此功能因爲時間不足尚未完成）
5. 個人：編輯個人資訊、查看粉絲與追蹤名單、查看自己發起的活動與參與的活動
...
即可開啟並使用此app  
使用此app時請使用手機模式（iphone XR 瀏覽）以獲得更好的體驗
(切換裝置模擬 -> 尺寸 iphone XR)
