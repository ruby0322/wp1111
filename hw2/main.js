...
const main = () => {
    ...
    openModalButtons = getAll('[data-modal-target]');
    closeModalButtons = getAll('[data-close-button]');
    ...
    openModalButtons.forEach(button => {
        button.addEventListener('click', () => {
            const modal = get(button.dataset.modalTarget);
            openModal(modal);
        });
    })
    overlay.addEventListener('click', () => {
        const modals = getAll('.modal.active');
